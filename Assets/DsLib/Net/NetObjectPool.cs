...
// outside of projectile object
// projectile.CreatePool();
// projectile.Spawn();
// 
// inside of projectile object
// transform.gameObject.Recycle();

public sealed class NetObjectPool : MonoBehaviour
{
	...
	static NetObjectPool _instance;
	...
	public static NetObjectPool instance
	{
		get
		{
			...
			_instance = Object.FindObjectOfType<NetObjectPool>();
			if (_instance != null)
				return _instance;
			...
			_instance = obj.AddComponent<NetObjectPool>();
			return _instance;
		}
	}
}
...
public static class ObjectPoolExtensions
{
	...
	{
		return NetObjectPool.Spawn(prefab, parent, position, Quaternion.identity);
	}
	...
	{
		return NetObjectPool.CountPooled(prefab);
	}
	...
	{
		return NetObjectPool.GetSpawned(prefab, list, appendList);
	}
	...
	{
		return NetObjectPool.GetSpawned(prefab, null, false);
	}
	...
	{
		NetObjectPool.DestroyPooled(prefab);
	}
	public static void DestroyPooled<T>(this T prefab) where T : Component
	{
		NetObjectPool.DestroyPooled(prefab.gameObject);
	}
